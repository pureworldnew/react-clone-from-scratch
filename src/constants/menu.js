    ...
    subs: [
      {
        ...
        label: 'menu.overview',
        to: `${adminRoot}/accounts/overview`,
      },
      {
        id: 'pages-product',
        label: 'menu.account',
        to: `${adminRoot}/accounts/account`,
        subs: [
          {
            icon: 'simple-icon-credit-card',
            label: 'menu.freelancer',
            to: `${adminRoot}/accounts/account/freelancer`,
          },
          {
            icon: 'simple-icon-list',
            label: 'menu.client',
            to: `${adminRoot}/accounts/account/client`,
          },
          {
            icon: 'simple-icon-grid',
            label: 'menu.recruiter',
            to: `${adminRoot}/accounts/account/recruiter`,
          },
          {
            icon: 'simple-icon-picture',
            label: 'menu.details',
            to: `${adminRoot}/accounts/account/details`,
          },
          {
            icon: 'simple-icon-book-open',
            label: 'menu.details-alt',
            to: `${adminRoot}/accounts/account/details-alt`,
          },
        ],
      },
    ],
