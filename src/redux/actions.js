...
export const REGISTER_USER_WITH_INFO = 'REGISTER_USER_WITH_INFO';
export const REGISTER_USER_WITH_INFO_SUCCESS =
  'REGISTER_USER_WITH_INFO_SUCCESS';
export const REGISTER_USER_WITH_INFO_ERROR = 'REGISTER_USER_WITH_INFO_ERROR';
export const SET_STEP = 'SET_STEP';
export const SET_STEP1_ITEM = 'SET_STEP1_ITEM';
export const SET_STEP3_ITEM = 'SET_STEP3_ITEM';
export const SET_STEP4_ITEM = 'SET_STEP4_ITEM';
export const SET_STEP5_ITEM = 'SET_STEP5_ITEM';
export const SET_STEP6_ITEM = 'SET_STEP6_ITEM';
export const SET_STEP7_ITEM = 'SET_STEP7_ITEM';
