module.exports = {
  ...
  'user.signup-now-free': 'Sign up now for FREE!',
  'user.signin': '    Sign in.',
  'user.fullname': 'Full Name',
  'user.login-proceed': 'PROCEED',
  'user.register-next': 'NEXT STEP',
  'user.signin-with-battle': 'Sign in with battle.net',
  'user.proceed-to-dash': 'Proceed to dashboard',
  'user.battle-dot-net': 'Battle.net',
  'user.login-button': 'SIGN IN',
  'user.proceed-button': 'PROCEED',
  ...
  'user.step2-title': 'What region do you play in?',
  'user.step3-title': 'What platform do you game on?',
  'user.step4-title': 'What is your play style?',
  'user.step5-title': 'What is your favourite weapon?',
  'user.step6-title':
    'Last step! Sign in with your relevant account to continue.',
  'user.step7-title': 'Great! Sign in with your relevant account to continue.',
  'user.step2-description':
    'Tell us where you play so we can match you with players near you.',
  /* 03.Menu */
  'menu.home': 'Home',
  'menu.app': 'Home',
  ...
  'menu.freelancer': 'Freelancer',
  'menu.client': 'Client',
  'menu.recruiter': 'Recruiter',
  ...
  'pages.account-name': 'Account Name',
